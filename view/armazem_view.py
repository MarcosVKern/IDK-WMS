...
class Armazem_View():
    ...
    def _setup_ui(self):
        ...
        tk.Entry(frame_form, textvariable=self.var_uf, width=30, bg=Cores_Padrao.COR_INPUT_BG, fg=Cores_Padrao.COR_TEXTO).grid(row=1, column=1, pady=5)

        tk.Label(frame_form, text="País:", bg=Cores_Padrao.COR_FUNDO).grid(row=2, column=1, sticky="w")
        tk.Entry(frame_form, textvariable=self.var_pais, width=30, bg=Cores_Padrao.COR_INPUT_BG, fg=Cores_Padrao.COR_TEXTO).grid(row=3, column=1, pady=5)

        tk.Label(frame_form, text="Nome:", bg=Cores_Padrao.COR_FUNDO).grid(row=4, column=1, sticky="w")
        tk.Entry(frame_form, textvariable=self.var_nome, width=30, bg=Cores_Padrao.COR_INPUT_BG, fg=Cores_Padrao.COR_TEXTO).grid(row=5, column=1, pady=5)
