...
class MovimentoEstoque_View():
    ...
    def _setup_ui(self):
        ...
        self.btn_adicionar = ctk.CTkButton(frame_form, text="Criar Movimento", command=self._acao_adicionar, fg_color=Cores_Padrao.COR_BOTAO_SALVAR, hover_color=Cores_Padrao.COR_BOTAO_SALVAR_HOVER, text_color=Cores_Padrao.COR_TEXTO_BOTAO, width=150)
