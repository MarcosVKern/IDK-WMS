...
class Produto_View():
    ...
    def _setup_ui(self):
        ...
        ctk.CTkButton(frame_botoes, text="Adicionar Produto", command=self._acao_adicionar, fg_color=Cores_Padrao.COR_BOTAO_SALVAR, hover_color=Cores_Padrao.COR_BOTAO_SALVAR_HOVER, text_color=Cores_Padrao.COR_TEXTO_BOTAO, width=150).pack(side=tk.LEFT, padx=5)
        ctk.CTkButton(frame_botoes, text="Atualizar Produto", command=self._acao_atualizar, fg_color=Cores_Padrao.COR_BOTAO_ATUALIZAR, hover_color=Cores_Padrao.COR_BOTAO_ATUALIZAR_HOVER, text_color=Cores_Padrao.COR_TEXTO_BOTAO, width=150).pack(side=tk.LEFT, padx=5)
        ctk.CTkButton(frame_botoes, text="Deletar Produto", command=self._acao_deletar, fg_color=Cores_Padrao.COR_BOTAO_DELETAR, hover_color=Cores_Padrao.COR_BOTAO_DELETAR_HOVER, text_color=Cores_Padrao.COR_TEXTO_BOTAO, width=150).pack(side=tk.LEFT, padx=5)
