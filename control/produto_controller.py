...
class Produto_Controller:
    ...
    def add_produto(self):
        try:
            ...
            self.view.show_message(f"Produto '{produto_salvo._nome}' adicionado com id {produto_salvo._id}!")
    ...
    def update_produto(self):
        try:
            ...
            if self.dao.update(produto_atualizado):
                self.view.show_message(f"Produto '{produto_atualizado._nome}' atualizado com sucesso!")
        except Exception as e:
    ...
    def delete_produto(self):
        try:
            ...
            if self.dao.delete(id_produto):
                self.view.show_message(f"Produto com id {id_produto} deletado com sucesso!")
            else:
